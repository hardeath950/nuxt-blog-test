...
<template>
  <NuxtLink :to="`/store/products/${props.product.id}`" class="group relative block overflow-hidden">
    <button
    ...
    <img
      :src="props.product?.images[0]?.url || 'https://cdlresende.com.br/wp-content/uploads/2018/03/no-image-icon-4.png'"
      alt=""
    ...
    <div class="relative border border-gray-100 bg-white p-6">
      ...
      <p class="mt-1.5 text-sm text-gray-700">
        {{ useProducts().getPrice(product)?.amount }}
      </p>
